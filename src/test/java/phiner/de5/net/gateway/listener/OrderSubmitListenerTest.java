...
public class OrderSubmitListenerTest {
    ...
    public void testOnMessage_success() throws Exception {
        ...
        mockedDecoder.when(() -> MsgpackDecoder.decode(body, SubmitOrderRequest.class)).thenReturn(request);
    ...
    public void testOnMessage_exception() {
        ...
        mockedDecoder.when(() -> MsgpackDecoder.decode(body, SubmitOrderRequest.class)).thenThrow(testException);
        ...
        verify(redisService).publishError("Failed to submit order: " + testException.getMessage());
    }
    ...
    public void testOnMessage_nullRequest() {
        ...
        mockedDecoder.when(() -> MsgpackDecoder.decode(body, SubmitOrderRequest.class)).thenReturn(null);
